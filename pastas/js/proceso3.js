        ...
        btn.addEventListener("click", async (e) => {
          ...
          if (producto.proceso_3) {
            ...
            ProductForm["caracteristicas"].value =
              producto.proceso_3.insumo.caracteristicas;
            ProductForm["documento"].value =
              producto.proceso_3.insumo.documento;
            ProductForm["certificado"].value =
              producto.proceso_3.insumo.certificado;
            ProductForm["fecha_retirar_malesa"].value =
              producto.proceso_3.fecha_retirar_malesa;
            ProductForm["fecha_distribuir_insumo"].value =
              producto.proceso_3.fecha_distribuir_insumo;
            ProductForm["fecha_acumular_insumo"].value =
              producto.proceso_3.fecha_acumular_insumo;
            ProductForm["fecha_aplicar_insumo"].value =
              producto.proceso_3.aplicar_insumo.fecha_aplicar_insumo;
            ProductForm["documento_aplicar_insumo"].value =
              producto.proceso_3.aplicar_insumo.documento_aplicar_insumo;
          } else {
            ProductForm.reset();
          }
        });
